...
In an environment of orders and protocols, the \hyperref[scene:upriver-journey]{upriver
	insistence on continuing}, whatever the evidence or cost, becomes intelligible as a defense of
non-instrumentality: continuing proves that one is not merely a key. Fulfillment punishes
